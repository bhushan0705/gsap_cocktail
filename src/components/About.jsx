...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="md:archivo-font w-full flex flex-col items-center justify-center py-30 px-4 bg-black text-white"
    >
      {/* Content Container */}
      <div className="max-w-[1280px] w-full flex flex-col gap-10">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10">
          <div className="flex items-start justify-center flex-col max-w-[500px] gap-4">
            <button className="font-medium border-2 px-5 py-2 rounded-full bg-white text-black">
              Best Cocktails
            </button>
            <p ref={detailRef} className="md:text-5xl text-3xl text-gray-300">
          ...
          <div className="max-w-[500px]">
            ...
            <div>
              <p className="text-2xl font-medium">
                <span className="text-5xl font-bold text-yellow-400">4.5</span>
                /5{" "}
              </p>
